...
import de.sciss.strugatzki.{FeatureCorrelation, Strugatzki, FeatureExtraction}
...
object Tests {
  ...
  def segmAndFillAndThen(fun: (Phrase, Vec[OverwriteInstruction], DifferanceDatabaseFiller) => Unit) {
