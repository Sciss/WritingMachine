...
//
//object Span {
//   def merge( spans: Traversable[ Span ]) : IndexedSeq[ Span ] = {
//      spans.foldLeft( IndexedSeq.empty[ Span ]) { (res, span) =>
//         val (ov, not)  = res.partition( _.touches( span ))
//         val union      = ov.foldLeft( span )( (a, b) => a.unite( b ))
//         not :+ union
//      }
//   }
//
